"""Acclerate blur operations with GPUs. 
...
class GaussianBlur:
    def __init__(self, rng=None):
        ...
        self.sigmas = [.5, 1, 2, 4, 8] # provide 5 level blur
...
class DefocusBlur:
    def __init__(self, nIn=1, ks=21, rng=None):
        self.rng = np.random.default_rng() if rng is None else rng
        self.c   = [(3, 0.1), (4, 0.5), (6, 0.5), (8, 0.5), (10, 0.5)]
        self.channels = nIn
        self.ks    = ks
...
class ZoomBlur:
    ...
    def __call__(self, img, mag=-1, prob=1.):
        ...
        for zoom_factor in c:
            ...
            print(zoom_img.shape, y1, y2, x1, x2)
